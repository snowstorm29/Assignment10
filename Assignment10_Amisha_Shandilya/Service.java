...
public class Service {
	...
	public void removeContact(Contact contact, List<Contact> contacts) throws ContactNotFound {
		if(contacts.contains(contact)) {
			contacts.remove(contact);
		}else {
			throw new ContactNotFound("This contact is not available");
		}
	}
	
	public Contact searchContactByName(String name, List<Contact> contact) throws ContactNotFound {
		...
		throw new ContactNotFound("Contact with this name is not available");
	}
	
	List<Contact> SearchContactByNumber(String number, List<Contact> contact) throws ContactNotFound{
		...
		if(contSet.size() == 0) {
			throw new ContactNotFound("This number does not match with any of the contacts");
		}
